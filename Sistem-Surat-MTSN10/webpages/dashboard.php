...
<aside class="pmd-sidebar sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
	<ul class="nav pmd-sidebar-nav">
        ...
        <li> 
			<a class="pmd-ripple-effect" href="dashbord.php?component=Pengajuansurat">	
        ...
        <li> 
			<a class="pmd-ripple-effect" href="dashbord.php?component=Pengajuanlegalisir&action=add">	
            <i class="media-left media-middle">
        ...
        <li> 
			<a class="pmd-ripple-effect" href="dashbord.php?component=Pengajuansurat&action=add">	
