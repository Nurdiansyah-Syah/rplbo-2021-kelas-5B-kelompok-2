                ...
                <div class="pmd-card-title">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Selamat Datang di Sistem Surat MTSN10</h3>
                        </div>
                        <div class="panel-body table-responsive">
                            <div class="col-md-6">
                                <center><img style="height: 400px" src="images/logo.png"></center>
                            </div>
                            <div class="col-md-6">
                                <div class="text-justify">
                                    <h3>Pengurusan Administrasi Akademik MTSN10 PEKANBARU:</h3>
                                    <table border="0">
                                        <tr>
                                            <td width="30"><i class="material-icons pmd-sm">screen_share</td></i>
                                            <td>
                                                <h5><a href="pengajuansurat.php">Pengajuan Surat</a></h5>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="30"><i class="material-icons pmd-sm">screen_share</td></i>
                                            <td>
                                                <h5><a href="pengajuanlegalisir.php">Pengajuan Legalisir</a></h5>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="30"><i class="material-icons pmd-sm">screen_share</td></i>
                                            <td>
                                                <h5><a href="pelacakan.php">Pelacakan Surat</a></h5>
                                            </td>
                                        </tr>
                                        </tr>
                                    </table>
