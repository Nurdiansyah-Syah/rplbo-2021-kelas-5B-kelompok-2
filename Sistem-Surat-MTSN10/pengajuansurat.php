                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form style="margin-left: 40px"
                                    action="dashboard.php?component=Pengajuansurat&action=save" method="post"
                                    enctype="multipart/form-data">
                                    <input type="hidden" name="id">
                                    <div class="pmd-card app-entry-card">
                                        <div class="pmd-card-title">
                                            <div class="pull-left">
                                                <h2 style="margin-top:7px;">Pengajuan Surat</h2>
                                            </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <div class="form-group form-group-sm">
                                                        ...
                                                        <select class="form-control" id="jenis_surat"
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $text; ?>"><?php echo $text; ?>
                                                            </option>
                                                            <?php
                                                            }
                                                            ?>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="text-justify">
                                        ...
                                        <table style="margin: 40px" border=" 0">
                                            <tr>
                                                ...
                                                <td>
                                                    <h5>Siswa mengajukan permohonan pembuatan Surat Aktif Sekolah,
                                                        Surat Bebas Bewasiswa, Surat Berkelakuan Baik</h5>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5>Setelah mengajukan pendaftaran online, siswa melakukan
                                                        verifikasi berkas di Bagian Akademik dan Kesiswaan
                                                        Sekolah dengan mengisi Formulir
                                                        untuk selanjutnya diverifikasi oleh Admin BAK.
                                                    </h5>
                                                </td>
                                            </tr>
                                ...
                                <td><h4 style="font-size: 40px">4</h4></td><td><h5>Silakan gunakan menu "Tracking Surat" untuk mengetahui status/posisi surat anda. Admin akan mengirimkan email pemberitahuan jika Surat Undangan telah selesai.</h5></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5>Surat yang sudah selesai dapat diambil di Bagian Akademik dan
                                                        Kemahasiswaan (BAK) Fakultas.</h5>
                                                </td>
                                            </tr>
